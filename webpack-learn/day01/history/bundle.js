(function (modules) { // webpackBootstrap
  ...
  function __webpack_require__(moduleId) {
    ...
    // Check if module is in cache 判断模块是否已经加载过
    if (installedModules[moduleId]) { // 有 直接使用缓存的exports
      return installedModules[moduleId].exports;
    }
    // Create a new module (and put it into the cache) 没有就安装该模块
